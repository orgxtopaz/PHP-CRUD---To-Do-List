...
?>
           ...
           ?>
                        ...
                        <div class="col-sm-4 ">
                          <div class="card">
                            <div class="card-body">
                              <p class="card-title" style="font-size: 12px;"> <i class="fa fa-trash" aria-hidden="true"></i> <?php echo $row['Deleted at']; ?> </p>
                              <div class="form-check">
                            
                              <label class="form-check-label " >
                              
                             <p class="check" name="Title" style="color:red;">Title: <?php echo $row['Title']; ?></p>
                              ...
                              <input class="form-check-input check1" style="top:-5px;" type="checkbox"  disabled value="">
                              <label class="form-check-label " >
                               <p class="check" name="Note" style="color:white;"> <?php echo $row['trash']; ?></p>
                              </label>
                            </div>
                            ...
                            <a href="connection.php?restore=<?php echo $row['ID']; ?>&trash=<?php echo $row['trash'];?>&Title=<?php echo $row['Title'];?>" ><i class="fa fa-arrow-right restore" aria-hidden="true"></i></a>
